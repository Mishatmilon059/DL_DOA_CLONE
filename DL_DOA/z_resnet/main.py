# ==========================================================================
# ResNet Memory Script
# ---------------------------------------------------------------
# This script runs the file inference using a trained model(ResNet), 
...
figures_dir = os.path.join(project_root, "figures_resnet")
...
# Import inference method for ResNet
from src.TVT_Blob_Inference import run_inference_and_metrics_resnet

# ===============================================================
# Run Main that call for inference and evaluate ResNet model metrics
# ===============================================================
if __name__ == "__main__":

    # Load pretrained ResNet model from path files and compute RMSE and Pd for all SNR conditions
    rmse, pd = run_inference_and_metrics_resnet("models/inf_model_007_256_resnet.h5")

    # Select configuration for plotting: L = 3 targets, QP = 16 compression quality
    target_L = 3
    target_QP = 16
    ...
    # Save plot to file
    output_path = os.path.join(figures_dir, "resnet_results.png")
    plt.tight_layout()
    plt.savefig(output_path, dpi=300)

    # ===============================================================
    # Save metrics on .pkl files for future comparison or analysis
    # ===============================================================
    rmse_path = os.path.join(figures_dir, "resnet_rmse.pkl")
    pd_path = os.path.join(figures_dir, "resnet_pd.pkl")
    ...
    print(" ·········· Saved RMSE and Pd dictionaries as resnet_rmse.pkl and resnet_pd.pkl ··········")
    print(f" ·········· Plot saved Correctly on figures_resnet folder ··········")
